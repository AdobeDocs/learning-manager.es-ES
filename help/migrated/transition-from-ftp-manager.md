...
Este es el mecanismo de autenticación básico. Seleccione la primera opción, **[!UICONTROL Crear autenticación básica usando una contraseña]**. Introduzca la contraseña y haga clic en **[!UICONTROL Connect]**.
