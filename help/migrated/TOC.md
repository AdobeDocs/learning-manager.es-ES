---
user-guide-title: Guía de Adobe Learning Manager
...
* Introducción {#introduction}
   * [Resumen de las nuevas funciones](whats-new.md)
   ...
   * [Recommendations en Adobe Learning Manager](recommendations-adobe-learning-manager.md)
   * [Transición desde el Administrador de FTP de Adobe](transition-from-ftp-manager.md)
* Introducción {#get-started}
   * [Primeros pasos como administrador](administrators/feature-summary/getting-started-admin.md)
...
* Administrador {#admin}
   ...
   * [Añadir ubicaciones de clase](administrators/feature-summary/classroom.md)
   * [Crear módulos de cursos, instancias y programas de aprendizaje](administrators/feature-summary/courses.md)
   ...
   * [Añadir usuarios en bloque](administrators/add-users-in-bulk.md)
   * [Suplantar a un alumno y responsable](administrators/feature-summary/impersonation-learner-manager.md)
   * [Varios inicios de sesión SSO](administrators/feature-summary/multiple-sso-logins.md)
   ...
   * [Lista de espera y gestión de asistencia](administrators/feature-summary/waitlist-attendance-management.md)
   ...
   * [Primeros pasos como administrador](administrators/feature-summary/getting-started.md)
   ...
   * [Experiencia de inicio de sesión no registrado para alumnos](administrators/feature-summary/non-logged-in-experience-learners.md)
* Administrador de integración {#integration}
   ...
   * [Instalar conector de Microsofts Teams](integration-admin/feature-summary/install-microsoft-teams-connector.md)
...
* Autores {#authors}
   ...
   * [Creación, modificación y publicación de cursos](authors/feature-summary/courses.md)
   * [Catálogos](authors/feature-summary/catalogs.md)
   * [Ayudas de trabajo](authors/feature-summary/job-aids.md)
   * [Integración con Adobe Connect](authors/feature-summary/adobeconnect-integration.md)
...
* Alumno {#learner}
   ...
   * [Lista de espera y gestión de asistencia](learners/feature-summary/waitlist-attendance-management.md)
   * [Aplicación Learning Manager para Salesforce](learners/feature-summary/sfdc-app.md)
   * [Integración con Adobe Connect](learners/feature-summary/adobeconnect-integration.md)
   ...
   * [aplicación de Adobe Learning Manager para escritorio](learners/adobe-learning-manager-app-for-desktop.md)
   ...
   * [Requisitos del sistema | aplicación de Adobe Learning Manager para escritorio](learners/adobe-learning-manager-app-for-desktop/adobe-learning-manager-desktop-app-system-requirements.md)
* Responsable {#manager}
...
* Base de conocimientos {#knowledge-base}
   ...
   * [Generar un archivo HAR](kb/generate-har-file.md)
   ...
   * [Solución de problemas de aplicaciones de Learning Manager](kb/troubleshooting-issues-with-adobe-learning-manager-desktop-app.md)
   ...
   * [Faltan los botones de opción](kb/selection-button-invisible.md)
