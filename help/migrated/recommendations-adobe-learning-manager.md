...
# Recommendations en Adobe Learning Manager
...
1. Realice los cambios en tiempo real.
...
1. Cree los parámetros de recomendación para productos y funciones.
...
1. Añada las funciones. Escriba los nombres de los roles y pulse Intro.
...
La función de recomendaciones es configurable. Así que en lugar de productos/roles/niveles, puede utilizar temas/roles/nivel o elegir cualquiera de estas opciones: producto/temas solamente, roles solamente, producto/temas y roles solamente, roles-niveles solamente o productos-niveles solamente.

En función de la configuración de recomendación que elija, modifique las hojas de datos en consecuencia.

En la siguiente sección se explica la opción más amplia de usar productos, funciones y niveles.
...
Para cargar los datos para que funcionen las recomendaciones, rellene los Productos, Funciones y Niveles en los archivos CSV User y RecommendationsLO.
...
| 456 | Aerospace Engg | Técnico | Técnico: avanzado |
...
| Training ID | Tipo de formación | Nombre del curso | Productos | Funciones | Niveles | Etiquetas | Aptitudes |
|---|---|---|---|---|---|---|---|
...
1. En la lista de parámetros, seleccione el icono de tres puntos y, a continuación, seleccione **[!UICONTROL Editar nombre de parámetro]**.
...
1. En la lista de parámetros, seleccione el icono de tres puntos y, a continuación, seleccione **[!UICONTROL Eliminar parámetro]**.
...
* Productos, funciones y niveles: se solicita a los alumnos que seleccionen primero los productos, las funciones y, a continuación, los niveles para cada una de las funciones seleccionadas
* Producto - Niveles: se solicita a los alumnos que seleccionen primero los productos y, a continuación, los niveles para cada uno de los productos seleccionados
* Roles: niveles: se solicita a los alumnos que elijan primero los roles y, a continuación, los niveles para cada rol seleccionado.
* Productos y funciones: se solicita a los alumnos que elijan primero los productos y, a continuación, las funciones.
* Productos: se solicita a los alumnos que seleccionen solo productos.
* Funciones: se solicita a los alumnos que elijan solo funciones.
...
Al hacer clic en Configurar Recommendations, el alumno accede a la ventana emergente de selección de productos.
...
El alumno puede añadir los niveles.

![añadir niveles](assets/image650040.png)
*Seleccionar niveles*

## Tiras de aprendizaje en la aplicación del alumno

Un alumno puede ver las siguientes tiras en la aplicación:

* Mi tira de aprendizaje
* Quitar con calendario, social y widget de interacción
* Salvado por mi tira
* Tira superrelevante
* Tira de productos - 1
* Tira de productos - 2
* Tira de descubrimiento
* Tira recomendada por el administrador
* Examinar por tira de catálogo
...
Cada tarjeta tiene los botones Valoración, Imagen de la tarjeta, Título, Aptitud, Fecha de publicación, Autor, Duración, Barra de progreso y los botones Iniciar, Explorar, Continuar o Regresar.

No hay ninguna barra de progreso en la tarjeta después de que un alumno inicie el curso. Un alumno también puede anular el guardado del curso.
...
No hay ninguna barra de progreso en la tarjeta después de que un alumno inicie el curso.
