...
El **catálogo** consta de todos los cursos, programas de aprendizaje, certificaciones y ayudas de trabajo disponibles para una función de alumno en la cuenta de la empresa.

Los alumnos pueden ver todos los objetos de aprendizaje asignados y disponibles para ellos (programas de aprendizaje, cursos y certificaciones) en el **catálogo predeterminado**. Estos objetos de aprendizaje son únicos para cada alumno según su función, designación, grupo de usuarios, perfil, etc.
...
Utilice la barra de búsqueda en la parte superior de la página para introducir los nombres de sus objetos de aprendizaje habituales. Los alumnos pueden cambiar entre la vista de cuadrícula y de lista seleccionando este icono ![](assets/icon-list.png).
...
También puede filtrar en función de duración de un curso de formación. El filtro de duración no incluye la duración del trabajo previo y de la prueba.
...
1. **[!UICONTROL Idioma del contenido]**: En primer lugar, aparecen los cursos en el idioma de contenido seleccionado.
2. **[!UICONTROL Idioma de interfaz]**: A continuación, se muestran los cursos en el idioma de la interfaz.
...
1. **[!UICONTROL Idioma del explorador]**: La aplicación prioriza los cursos en función de la configuración de idioma del navegador.
2. **[!UICONTROL Idioma de la cuenta]**: Si el idioma del navegador no está disponible, se tiene en cuenta el idioma de la cuenta de ALM.
3. **[!UICONTROL Valor predeterminado en inglés]**: Si el explorador o el idioma de la cuenta no están disponibles, los cursos se muestran en inglés.
