...
**Guardados por mí widget**

* **Administrador:** Los administradores pueden colocar el widget Guardado por mí en una página para que los alumnos puedan encontrar fácilmente el contenido que tienen marcado. Esto permite a los alumnos volver a los cursos que habían guardado con anterioridad sin tener que volver a buscarlos o acceder a ellos. Más información sobre el widget [Guardados por mí](/help/migrated/administrators/feature-summary/experience-builder/add-a-widget.md#bookmark-widget).

* **Alumno:** El widget **Guardados por mí** muestra los cursos, las rutas de aprendizaje, las certificaciones y las ayudas de trabajo que has marcado para más adelante. Utilice este widget para acceder rápidamente al contenido guardado en un lugar, sin tener que volver a buscar en el catálogo. Más información sobre el widget [Guardados por mí](/help/migrated/learners/feature-summary/saved-by-me-widget.md).

**Color del tema del canal:** Al crear un canal, tiene más colores de tema del canal entre los que elegir. Los colores del tema se aplican contextualmente para resaltar el contraste después de la selección. Al seleccionar un color de tema para el canal, el color seleccionado se aplica a la interfaz del canal y se ha diseñado para mantener el contraste con las miniaturas y el texto del canal. Un color predeterminado se asigna automáticamente al crear un canal, pero puede elegir un color diferente de las opciones disponibles en cualquier momento.

**Miniaturas de vídeo:** El alumno ahora puede identificar rápidamente un vídeo por su icono, que a su vez muestra una miniatura para ayudar a identificar su contenido de un vistazo. Si el vídeo de origen no proporciona su propia imagen en miniatura, Adobe Learning Manager genera automáticamente una utilizando el color del tema del canal, un patrón abstracto y el título del vídeo.

**Canales:** La opción de navegación Canales solo está visible para los alumnos cuando se ha creado al menos un canal, contiene al menos un vídeo de su origen y está marcada como Visible para los alumnos. Obtenga más información sobre [Canales](/help/migrated/administrators/feature-summary/create-channels.md).

## Errores corregidos

**Componente Adobe Experience Manager:** Después de actualizar al paquete del sitio de referencia de Adobe Learning Manager v2.0.1, el panel Notificaciones no se pudo cargar cuando los usuarios hicieron clic en la campana de notificación. El cargador siguió girando indefinidamente, impidiendo que se mostraran las notificaciones. El problema también provocaba llamadas repetidas al extremo /userNotifications, lo que a la larga provocaba respuestas HTTP 429. El flujo de trabajo de carga de notificaciones se ha solucionado para evitar un exceso de solicitudes de API y resolver el problema de carga. Las notificaciones ahora se cargan correctamente y el panel se abre según lo previsto sin una limitación de API innecesaria.

**Aplicación móvil de Adobe Learning Manager > Ruta de aprendizaje:** Los cursos completados en una ruta de aprendizaje de la aplicación móvil de Adobe Learning Manager se mostraban incorrectamente con un indicador amarillo y un punto rojo, aunque su estado estuviera marcado como completado. Esta incoherencia visual se producía solo para los cursos dentro de las rutas de aprendizaje, mientras que los módulos completados se mostraban correctamente. La lógica del indicador de estado se ha solucionado para los cursos de la ruta de aprendizaje en la aplicación móvil. Los cursos completados ahora muestran el indicador verde de finalización correcto. Esto garantiza una experiencia de finalización coherente en la aplicación móvil y el navegador de escritorio.

+++


+++Actualización 10: Versión del 16 de agosto de 2026 de Adobe Learning Manager
...
En el frente de IA, el Asistente de IA para alumnos obtiene resúmenes de cursos, comparación de objetos de aprendizaje, respuestas de Adobe Experience League y consultas de contenido de terceros de los catálogos de Go1 y LinkedIn Learning; un nuevo agente de ruta de aprendizaje guía a los alumnos a través de una conversación para generar automáticamente una ruta de aprendizaje secuenciada personalizada; y el agente de Insights lleva las consultas de lenguaje natural a los informes de administrador. Todas las funciones de IA se rigen por un nuevo sistema de créditos de IA de generación en la página Facturación, lo que proporciona a los administradores límites de uso por función y alertas de consumo.
...
### Función de aprendizaje externo: Nuevas columnas en la transcripción del alumno

Estos añaden campos personalizados de aprendizaje externo específicos de la cuenta al informe de LT. En Admin LT, las nuevas columnas de campos personalizados se agregan al final; en el documento de aprendizaje, los campos Nombre del aprendizaje externo y Comentario de finalización se insertan cerca del módulo relacionado y los campos del revisor, y los campos personalizados restantes se añaden al final.
...
### ID de formación raíz para certificaciones en transcripciones de alumnos

De este modo, se añade una nueva columna ID de formación raíz tanto a la formación de administrador como a la de alumno. La columna aparece al final del informe y ayuda a identificar el contexto de certificación principal para el registro del alumno.

Obtén más información sobre los [cambios en los informes de la versión de agosto de 2026 de Adobe Learning Manager](/help/migrated/reporting-changes-august-2026.md).

### Alineación del formato de fecha y hora de Webhook con transcripciones de alumnos

Esto estandariza los valores de fecha y hora de los objetos de datos webhook para que tengan una precisión de minutos. Los segundos siempre se emiten como 00, alineando las marcas de tiempo de webhook con el formato de informe LT.

Obtén más información sobre los [cambios en los informes de la versión de agosto de 2026 de Adobe Learning Manager](/help/migrated/reporting-changes-august-2026.md).

### Columna Grosor en transcripciones de alumnos

Se agrega una columna Grosor al informe LT para los módulos de cursos habilitados para Libro de calificaciones. Esto muestra el peso del módulo directamente en la salida del informe.

Obtén más información sobre los [cambios en los informes de la versión de agosto de 2026 de Adobe Learning Manager](/help/migrated/reporting-changes-august-2026.md).

### Detalles del autor del curso compartido en la API learningObjects

Los detalles actualizan la respuesta del objeto de aprendizaje de la API para los cursos compartidos, de modo que las cuentas de recepción ya no muestran al administrador aceptante como autor. Solo los detalles del autor externo original se exponen en cuentas de igual a igual; el comportamiento de la cuenta principal no cambia.

### Detección de intención en el agente de AI Orchestrator

El agente de AI Orchestrator traslada la detección por intención de las solicitudes de consulta única al orquchestrator y elimina los conmutadores manuales de la interfaz de usuario. El enrutamiento de consultas puede cambiar entre los flujos de preguntas y respuestas y de PLP en función de la intención detectada.

## Errores corregidos en la versión

**Transcripciones de alumnos:** Las fechas en el informe de transcripciones de alumnos solían registrar 00 durante segundos, mientras que en webhook los segundos aparecían como debían, con dos dígitos. Esto se ha solucionado. La transcripción del alumno ahora también muestra correctamente los segundos de dos dígitos.

**Instancia:** Cuando se canceló una sesión de Adobe Connect VC o de Microsofts Teams desde la página de instancias, algunos detalles de la sesión asociada permanecieron después de actualizar la página. Este problema se ha solucionado, y las sesiones canceladas ahora eliminan correctamente todos los detalles asociados, incluida la configuración de omisión del vestíbulo y organizador de equipos y el instructor principal de Connect.

**API:** Un problema en un flujo de trabajo automatizado de AWS provocaba que las solicitudes de descarga repetidas a la API HTTP del CMS usaran direcciones URL codificadas incorrectamente, lo que provocaba errores intermitentes de HTTP 500 y grandes volúmenes de tráfico no válido. El flujo de trabajo se ha actualizado para codificar correctamente espacios de URL y otros caracteres especiales en las URL de solicitud de descarga. Como resultado, las solicitudes de descarga de activos de cuentas se procesan correctamente, lo que reduce los errores y mejora la fiabilidad de la recuperación de activos automatizada.

**Alumno:** Un problema provocaba que el formato de cursiva aplicado en la sección Información general detallada de un curso se mostrara correctamente durante la creación, pero no en la página de información general del curso dirigida al alumno después de la publicación. La lógica de procesamiento se ha actualizado para conservar el formato de texto en cursiva cuando se publica el contenido del curso. Como resultado, las cursivas aplicadas en la sección Información general detallada se muestran correcta y coherentemente para los alumnos en la página de información general del curso publicado.

**Certificaciones personalizadas:** La vista previa del certificado mostraba un fondo blanco cuando se cargaba una imagen de SVG como fondo del certificado para un certificado de logro. El proceso de procesamiento de la vista previa del certificado se ha actualizado para admitir y mostrar correctamente las imágenes de fondo cargadas del SVG. Como resultado, las vistas previas de certificados ahora procesan el fondo del SVG configurado como se esperaba, lo que proporciona una representación precisa del certificado final.

**Autor:** La generación de archivos VTT para vídeos interactivos largos podría experimentar retrasos significativos, con tiempos de procesamiento que superarían las dos horas para algunas cargas. Este problema se ha investigado y optimizado para mejorar el rendimiento y la fiabilidad de la generación de VTT en archivos de vídeo de gran tamaño. Como resultado, los archivos VTT ahora se generan de forma más eficaz, lo que proporciona un flujo de trabajo de subtítulos más rápido y coherente para las cargas de vídeo interactivo.

**API:** La API de exportación de informes no devolvía algunos registros de finalización de alumnos, aunque los datos de finalización existían en el motor, coincidían con el intervalo de fechas especificado y los filtros de grupos de usuarios, y cumplían todos los criterios del informe. El proceso de exportación de informes para las finalizaciones de alumnos en varios trabajos y la lógica de recuperación de datos se han mejorado para garantizar que los registros de finalización elegibles se incluyan de forma coherente en las exportaciones de la API. Las respuestas de la API de exportación de informes ahora devuelven datos de finalización de alumno completos para los usuarios cuyas marcas de tiempo de finalización se encuentran dentro del intervalo de fechas solicitado y del ámbito de filtro, lo que proporciona resultados de informes más precisos y fiables.

**Webhook:** Cuando un alumno se inscribió en una sesión que se canceló posteriormente, al inscribirse en otra sesión del mismo curso no se desencadenó un nuevo evento de webhook de inscripción, a menos que se cancelara primero la inscripción del alumno en la sesión cancelada. Esto provocaba que los sistemas descendentes no recibieran las actualizaciones de inscripción válidas para las instancias canceladas o completadas anteriormente. El flujo de webhook se ha actualizado para que se active un nuevo evento de inscripción cuando un alumno se inscribe en otra sesión del mismo curso después de que se cancele o complete la sesión anterior, lo que garantiza que la actividad de inscripción se notifique de forma coherente.

**API:** Las solicitudes de la API de administración para rutas de aprendizaje que incluían muchos datos relacionados (como instancias, inscripciones, recursos y calificaciones) experimentaron una degradación significativa del rendimiento, con tiempos de respuesta que aumentaron de los típicos cinco a ocho segundos a hasta 45 a 60 segundos, lo que afectó a los flujos de trabajo de integración y a los sistemas descendentes. Se han implementado optimizaciones de rendimiento para incluir solicitudes de objetos de aprendizaje pesados para mejorar la eficiencia de la recuperación de datos. Las llamadas a la API de rutas de aprendizaje que incluyen relaciones anidadas complejas ahora devuelven resultados de forma más coherente y con tiempos de respuesta mejorados, lo que ayuda a garantizar un rendimiento de integración fiable.
...
**API:** Cuando los alumnos ordenaron el catálogo por nombre en orden ascendente (A-Z), la API pública devolvió resultados mediante la ordenación que distingue mayúsculas de minúsculas, lo que hizo que los nombres de cursos en mayúsculas (AA, BB, CC) aparecieran antes que los nombres en minúsculas (aa, bb) en lugar de seguir el orden alfabético estándar. La lógica de ordenación se ha actualizado para utilizar la comparación sin distinción de mayúsculas y minúsculas. Los resultados del catálogo ahora se muestran en la secuencia alfabética esperada, independientemente de la letra, lo que garantiza un orden coherente de los nombres de los cursos.

**CR-VC:** Cuando se agregó un nuevo instructor a un curso de clase virtual, no se envió ningún correo electrónico de invitación a la sesión si la plantilla de correo electrónico &quot;Se le ha agregado como instructor, organizador o coorganizador&quot; estaba deshabilitada, lo que impedía que los instructores recibieran los detalles de la sesión. Se ha corregido la lógica de notificación para garantizar que las invitaciones de sesión del instructor se generen independientemente de la plantilla.

**Común del cliente:** Cuando se actualizó la duración de un módulo de actividad después de añadir el curso a un plan de aprendizaje del activador de inscripción automática (AET), la vista previa del alumno siguió mostrando la duración de la instancia de AET en lugar de la duración actualizada de la instancia del curso predeterminada. Este problema se ha solucionado garantizando que la vista previa del alumno recupere la duración del módulo de la instancia de curso correcta. Las vistas previas del alumno ahora muestran con precisión la duración más reciente del módulo publicado, reflejando las actualizaciones realizadas en el contenido del curso.

**Alumno:** En una certificación ordenada, los alumnos podían omitir un primer curso erróneo y acceder a un segundo curso bloqueado completando su requisito previo, lo que permitía marcar la certificación como completada cuando el requisito se establecía en cualquier curso. La validación se ha actualizado para aplicar el orden del curso y las reglas de bloqueo de forma coherente. Los alumnos ahora pueden completar los requisitos de certificación solo en la secuencia definida, lo que evita que los cursos bloqueados contribuyan a la finalización de la certificación.

**API:** Cuando se agregó un recurso a un curso sin una descripción, la API GET /learningObject/{id} no devolvió una descripción recién agregada si el recurso se actualizó más tarde. Como consecuencia, los metadatos de recursos obsoletos se exponían a través de la API. Se ha solucionado el problema de sincronización y la API ahora devuelve la descripción de recurso más reciente, independientemente de cuándo se agregó.

**API:** Cuando se migró un módulo con una descripción y la descripción se actualizó posteriormente, el valor actualizado se guardó correctamente en la tabla de módulos, pero no se reflejó en la interfaz de usuario. La interfaz de usuario siguió mostrando la descripción anterior porque se obtenía del registro content_group, que no se actualizaba durante la modificación. Este problema de sincronización se ha resuelto y las descripciones actualizadas de los módulos ahora se reflejan de forma coherente en la interfaz de usuario después de la migración.
...
Cuando la configuración regional de la interfaz de usuario está establecida en un idioma distinto del inglés, el archivo CSV exportado desde la página Ubicaciones de Clase muestra los nombres de columna (la fila de encabezado) en inglés en lugar de hacerlo en el idioma seleccionado.

Este comportamiento se produce durante la exportación de ubicaciones de clase desde el perfil de administrador > Configuración > Ubicaciones de clase. Si bien los datos de ubicación dentro del archivo se devuelven correctamente, los encabezados de columna no se traducen para que coincidan con la configuración regional de la interfaz de usuario elegida por el administrador. Como resultado, un administrador que trabaje en una configuración regional distinta del inglés verá los nombres de columna en inglés en un entorno localizado de otro modo.

Sólo se ve afectada la fila de encabezado; los datos de ubicación subyacentes en el archivo exportado no se ven afectados. No se incluye ninguna corrección en esta versión y el problema se está evaluando para una futura versión.

### El campo Duración del crédito limita la entrada a 9999,99

Cuando un usuario introduce un valor de Duración de crédito mayor que 9999.99, como 999999, en el formulario de edición de sesión, el valor se limita de forma silenciosa a 9999.99 al guardar, sin que se muestre ningún error de validación ni advertencia al usuario. El campo tiene un atributo HTML max establecido en 9999.99, que aplica este límite en el nivel del explorador sin notificar al usuario que se rechazó o modificó su entrada. No se ha aplicado ninguna corrección en esta versión, ya que se confirma que este comportamiento funciona según lo previsto.

### El mensaje de error no indica que falte una fila en el idioma predeterminado en las cargas de CSV

Cuando una carga de CSV de ubicación estructurada contiene filas solo en configuraciones regionales no predeterminadas, como fr, de y ninguna fila en el idioma predeterminado de la cuenta, el mensaje de error devuelto es Configuración regional en la fila 1 del CSV y la columna 2 no es válida o no se admite. Esto no indica que el problema real sea una fila de idioma predeterminado que falta. Esto evita que los usuarios carguen archivos CSV en varias configuraciones regionales y diagnostiquen el problema únicamente mediante mensajes de error. Este problema se ha eliminado para esta versión sin aplicar ninguna corrección.

### El campo Límite de puestos permite valores poco realistas de hasta 4.294.967.295

El campo Límite de puestos en el modo Ubicación de clase acepta cualquier valor de hasta 4.294.967.295 ( ~4.300 millones), un límite que se basa técnicamente en el tipo de datos subyacente en lugar de una restricción empresarial realista. Los usuarios pueden introducir y guardar recuentos de puestos poco realistas, como 1.000.000.000, sin que ninguna validación de nivel empresarial los rechace.
No se ha aplicado ninguna corrección para esta versión; aún no se ha acordado ni se ha aplicado un máximo empresarial realista.
...
**Disponibilidad de cursos adquiridos en certificaciones periódicas:** Anteriormente, los cursos adquiridos solo se podían agregar a certificaciones perpetuas. Las certificaciones periódicas no mostraban los cursos adquiridos en el panel de selección de cursos, lo que impedía que las cuentas de destinatarios usaran contenido compartido para los programas que requerían renovación periódica. Los cursos adquiridos ahora están disponibles en certificaciones permanentes y periódicas. Para obtener más información, consulte [Características del catálogo compartido en la aplicación receptora](/help/migrated/administrators/feature-summary/catalogs.md#sharedcatalogfeaturesinreceiverapplication).

**Migración de la sesión VILT a Adobe Learning Manager:** Adobe Learning Manager ahora admite la migración en bloque y la actualización de los datos de sesión de formación virtual guiada por instructor (VILT) a través de archivos CSV. Utilice este flujo de trabajo para configurar las fechas de inicio de las instancias, asociar instancias de rutas de aprendizaje a instancias de cursos y configurar sesiones de clase virtual para Microsofts Teams, Adobe Connect y Zoom. Para obtener más información, consulte el [Manual de migración](/help/migrated/integration-admin/feature-summary/migration-manual.md#migrationofviltsessiontoalm)

## Mejoras de esta versión

**Inversión del orden de escala Likert:** En Adobe Learning Manager, la escala Likert se utiliza para valorar la experiencia del alumno con objetos de aprendizaje. La escala Likert en el formulario de comentarios de la experiencia del alumno se ha invertido para que coincida con el orden estándar de izquierda a derecha. Anteriormente, la escala Likert tenía un orden de derecha a izquierda, en contra del orden estándar de izquierda a derecha. La puntuación comienza ahora con Muy en desacuerdo a la izquierda y termina con Muy en desacuerdo a la derecha.

**Correos electrónicos ad hoc a alumnos de instructores:** Anteriormente, la opción Enviar correo electrónico a todos solo permitía a los instructores copiar las direcciones de correo electrónico de los destinatarios. Ahora permite a los instructores enviar correos electrónicos ad hoc directamente a los alumnos utilizando la misma opción. La opción Copiar correos electrónicos solo se puede utilizar para copiar las direcciones de correo electrónico de los destinatarios.

### Pasos

1. Inicie sesión como instructor.
2. Vaya a Sesiones anteriores en el panel de navegación izquierdo. En la página aparecerá una lista de las sesiones anteriores.
3. Seleccione un nombre de sesión de la lista de sesiones anteriores.
4. Vaya a Alumnos en el panel de navegación izquierdo.
   ![](assets/instructor-send-email1.png)
5. Seleccione un alumno de la lista de alumnos.
6. En la parte superior derecha, se abre la lista desplegable **Acciones** para mostrar más opciones (incluidas las atenuadas). **Enviar correo electrónico a todos** es una de las opciones.
   ![](assets/instructor-send-email2.png)

**Purga automática de usuarios eliminados:** La purga automática de usuarios eliminados se estableció en un año como el período mínimo requerido para la eliminación. Esto se ha mejorado para incluir también un número en &quot;días&quot;. Ahora, los administradores pueden solicitar este cambio poniéndose en contacto con su administrador de éxito de clientes y cambiándolo desde el back-end.

## Errores corregidos

**Creación**

1. Las configuraciones regionales con puntuaciones de baja calidad de traducción ya no se muestran en el modo de generación de subtítulos al generar automáticamente archivos de subtítulos VTT. Esto evita que se entreguen a los alumnos traducciones de mala calidad, como la representación inexacta de caracteres chinos.

2. La plantilla de correo electrónico de bienvenida (interna) ahora tiene configuraciones independientes para los métodos de inicio de sesión de Adobe ID y SSO. Anteriormente, ambos métodos de inicio de sesión compartían un único canal de plantilla, lo que provocaba que la plantilla se volviera a habilitar cuando se configuraba SSO después de que la plantilla se hubiera deshabilitado, lo que provocaba que se enviaran correos electrónicos de bienvenida no deseados a los alumnos.

**Certificación**

Las certificaciones recurrentes ahora obtienen cursos de la versión más reciente (principal) de la certificación en lugar de la versión original (raíz). Esto garantiza que el contenido actualizado del curso se incluya correctamente en cada ciclo de certificación.

**Funciones personalizadas y biblioteca de contenido**

1. Los autores personalizados con acceso restringido a carpetas de contenido seleccionadas ahora pueden obtener una vista previa de los módulos de cursos AICC y Tincan mediante la opción Vista previa como alumno sin recibir el mensaje de error &quot;Contenido no disponible&quot;.

2. Los autores personalizados con acceso a las carpetas de contenido y los catálogos seleccionados ahora pueden abrir los recursos del curso en la vista Vista previa como alumno sin encontrar un error de acceso 403.

**Datos e informes**

La sincronización de datos de inscripción se ha estabilizado resolviendo un error del conector de base de datos y cargas de registro de gran tamaño en la canalización de datos. Los registros de inscripción ahora se transmiten de forma fiable a los sistemas de informes descendentes.

**Publicación y API**

Las API públicas **Search** y **Categories** ahora devuelven ID de catálogo en el formato numérico correcto. Anteriormente, los ID de catálogo se devolvían con el formato de cadena incorrecto &quot;catalog123&quot; en lugar del ID numérico esperado.

**IU y administración**

1. La página Instancia del curso de los cursos con nominación de responsable ya no muestra un diseño roto para los usuarios de administrador y administrador personalizado. Se ha corregido una regresión CSS que provocaba el desbordamiento de elementos sin ajuste.

2. Los usuarios externos que hacen clic en los vínculos de invitación de sesión VILT desde su correo electrónico ahora se redirigen correctamente a su método de inicio de sesión configurado (por ejemplo, Adobe ID) en lugar de enrutarse incorrectamente a la página de inicio de sesión de SSO interno.

**Asistente de inteligencia artificial**

El Asistente de IA ahora proporciona una respuesta correcta cuando se le pregunta si se puede añadir una ruta de aprendizaje a una certificación. El auxiliar respondió afirmativamente de manera inexacta; ahora indica correctamente que solo se pueden añadir cursos a las certificaciones en Adobe Learning Manager.

## Problema conocido

**Tiempo empleado en la transcripción del alumno para la asistencia a la clase basada en QR:** Se ha confirmado que el tiempo dedicado a mostrar como 0 minutos la asistencia de los alumnos que se marcaron a sí mismos mediante código QR funciona según lo diseñado. La duración de la sesión registrada en la transcripción del alumno se deriva de los datos de xAPI emitidos en el tiempo de finalización. En los casos en los que los datos de programación de sesión aún no se hayan confirmado en la base de datos en el momento en que se procesa la finalización, se registra una duración de cero. No se ha aplicado ninguna corrección para esta versión.

+++

+++Actualización 107: Versión de mayo de 2026 de Adobe Learning Manager
...
Experience Builder ya está disponible para todas las cuentas de Adobe Learning Manager, lo que permite a los clientes crear experiencias de aprendizaje totalmente de marca mediante componentes de código bajo y diseños flexibles. Experience Builder permite a los administradores crear portales de aprendizaje personalizados y páginas totalmente adaptables a dispositivos móviles.

Para las cuentas existentes, la actualización de Experience Builder se implementará automáticamente. La función Experience Builder no está disponible para las cuentas que siguen utilizando la interfaz de usuario antigua o la clásica.

Vea [Experience Builder](/help/migrated/administrators/feature-summary/experience-builder/overview.md) para obtener más información.

### Interfaz web móvil de Adobe Learning Manager

La interfaz web para dispositivos móviles se ha reconstruido sobre un código base moderno para ofrecer tiempos de carga más rápidos, una mayor capacidad de respuesta y una experiencia de aprendizaje más intuitiva en todos los dispositivos.

La experiencia web móvil actualizada está activada de forma predeterminada para todas las cuentas nuevas. Las cuentas existentes también recibirán la actualización automáticamente, excepto cuando se habilite el Aprendizaje social. En estos casos, la experiencia móvil anterior permanecerá activa hasta que Aprendizaje social se migre al nuevo marco compatible.

>[!NOTE]
>
>La nueva interfaz web móvil de Adobe Learning Manager no admite el aprendizaje social.

### Mejoras del reproductor Fluidic

Anteriormente, el botón Siguiente del reproductor Fluidic no mostraba el título del próximo módulo, lo que dificultaba que los alumnos previeran el siguiente paso en su recorrido de aprendizaje.

Con esta mejora, el botón Siguiente ahora incluye el título del siguiente módulo, lo que permite a los alumnos:

* Entiende el contenido que está apareciendo antes de que continúe.
* Navegue por los módulos con más claridad y confianza.
* Mantén un mejor contexto a lo largo del flujo del curso.

![](assets/fluidic-player-next.png)
_El reproductor Fluidic muestra ahora el botón Siguiente con el título del próximo módulo_

### Formulario de comentarios de L1

Los comentarios de L1 solo se pudieron configurar dentro de objetos de aprendizaje individuales, lo que limitó la flexibilidad e impidió que los administradores utilizaran diferentes formularios en todo el catálogo. Los administradores ahora pueden crear y utilizar varios formularios de comentarios de L1 y cada formulario de comentarios se puede asignar a cursos, rutas de aprendizaje y certificaciones específicos. El formulario ahora admite varios tipos de preguntas, incluidas las preguntas sobre eficacia de los cursos, NPS, escala Likert y texto libre.

Los formularios de comentarios se pueden traducir a otros idiomas, manteniendo la misma estructura de preguntas en todas las configuraciones regionales. Los informes ahora incluyen el nombre y la versión del formulario de comentarios para ayudar a identificar el formulario que ha capturado cada respuesta.

**Casos prácticos**

* Asigna formularios de comentarios personalizados a diferentes programas de formación. Por ejemplo, los cursos de ventas pueden usar preguntas centradas en NPS, mientras que los cursos de cumplimiento pueden usar preguntas de eficacia del curso y de escala Likert para medir la claridad y la comprensión de las políticas.
* Utiliza formularios de comentarios independientes basados en módulos de aprendizaje. Por ejemplo, tres formularios diferentes para módulos combinados, módulos con ritmo personalizado y módulos de clase.

Vea [formulario de comentarios de L1](/help/migrated/administrators/feature-summary/l1-feedback-form.md) para obtener más información.
...
La función de ordenación de la aplicación del alumno proporciona recomendaciones de cursos personalizadas basadas en el contenido y el idioma de la interfaz. Esta mejora simplifica el proceso para que los alumnos encuentren los cursos en su idioma preferido y utilicen opciones de ordenación más inteligentes.
...
* Se agrega una nueva columna Completado por a los informes LT. Esto ayuda al administrador a identificar el origen de la finalización de un objeto de aprendizaje.
...
**Fecha de publicación:** 05 de noviembre de 2022

**Nota:** Con esta versión de Adobe Learning Manager, los usuarios con cuentas inactivas ya no pueden acceder a sus cuentas mediante subdominios. Se puede acceder a las cuentas mediante el ID de cuenta, o bien a través de la página acapindex.html e introduciendo el ID de correo electrónico.
...
* No era posible eliminar un curso o una ruta de aprendizaje si tenían una asociación histórica con un plan de aprendizaje. Esto ya se ha solucionado. Los usuarios ahora pueden eliminar un curso o una ruta de aprendizaje si no están asociados actualmente a un plan de aprendizaje.
...
* Como administrador, las fechas de inicio y finalización de un anuncio no se guardaban si el idioma de la interfaz y del contenido se establecía en alemán/español. Este problema ya se ha solucionado.

**Plantilla de correo electrónico**

* Las invitaciones de sesión que abarcan varios días en los que las invitaciones no reflejaban la información correcta sobre los días están bloqueados en algunos clientes de correo electrónico. Esto ya se ha solucionado.
...
* Al reorganizar los informes en el tablero de informes para las funciones de administrador y responsable, no se conservaba el estado del orden de los informes. Este problema ya se ha solucionado.
...
* En el caso europeo, el contenido de Learning Manager que se publicaba directamente en Adobe Learning Manager desde Adobe Captivate se publicaba de forma predeterminada en la configuración regional de alemán (Deutsch). Esto ya se ha solucionado.
...
Learning Manager ofrece un tablero de cumplimiento a todos los administradores y los responsables. A los responsables les resulta muy útil realizar un seguimiento del cumplimiento de los miembros del equipo para un determinado curso de formación. Al mismo tiempo, a los administradores les gustaría que todos los responsables añadieran formación de cumplimiento a su tablero y realizaran un seguimiento del mismo.

En Learning Manager, el flujo de trabajo **Compartir con responsables** permite a los administradores compartir la formación con los responsables para que puedan ser añadidos al tablero de cumplimiento de un responsable. Por lo tanto, los responsables no necesitan realizar ninguna acción y pueden comenzar a realizar el seguimiento del cumplimiento al instante.
...
Las rutas de aprendizaje sustituyen a la función existente de los programas de aprendizaje. Imagina que los programas de aprendizaje obtengan mejoras potentes sin eliminar las capacidades existentes. Además, la función se marca como una ruta de aprendizaje.
...
* Las plantillas de correo electrónico, como por ejemplo la desinscripción de cursos, la desinscripción de programas de aprendizaje o la desinscripción de certificaciones, no reflejan las terminologías de productos más recientes, tal como se definen en el archivo csv. Ahora, el texto predeterminado de las plantillas de correo electrónico admite terminologías personalizadas.
* El idioma del usuario en Learning Manager no se admite en el flujo de trabajo Publicar en Learning Manager. Si el idioma del usuario es diferente, Publicar en Learning Manager se muestra en inglés.
* Si añade muchos catálogos a una función personalizada, se producirá un error al actualizar la función. Ahora, el límite de catálogos aumenta hasta 50 catálogos.
...
* Cuando se cambiaba la función de responsable de un usuario a otro, la función de responsable del usuario anterior se reflejaba en la interfaz de usuario. Esto ya se ha solucionado. Este problema solo estaba presente para usuarios externos y no para usuarios internos.
...
* Externalización de la obtención y el almacenamiento de mensajes de correo electrónico/tokens de usuarios para que los usuarios puedan implementar su propio back-end de almacenamiento en lugar de utilizar los nodos de usuario de AEM.
...
* **Compatibilidad mejorada de la accesibilidad:** la compatibilidad de la accesibilidad con la función del alumno se ha optimizado mediante la mejora de la navegación por teclado, la capacidad del lector de pantalla y la conformidad con la relación de contraste.
* **Formato de texto enriquecido:** Learning Manager ahora ofrece edición de texto enriquecido para descripciones de cursos, programas, certificados y ayudas de trabajo. Esto permite a los autores especificar descripciones mediante texto enriquecido, incluidos hipervínculos, imágenes y otras opciones de formato de texto, en lugar de texto sin formato.
* **Valoración basada en estrellas:** un alumno puede ahora valorar un curso con una escala de 5 puntos. Un administrador puede seleccionar entre la clasificación de la eficacia existente o la valoración de 5 estrellas.
...
* Capacidad de los administradores y los responsables de ver las aprobaciones pendientes de los cursos. Esto permite garantizar que los responsables realicen un seguimiento del aprendizaje y la formación de los empleados y que los administradores de Learning Manager aprueben la inscripción en cursos según sea necesario.
...
La actualización 3.3 de la aplicación móvil de Captivate Learning Manager presenta una nueva página de inicio que admite encabezados y recomendaciones de formación basadas en Inteligencia artificial. Esta página de inicio está disponible para todas las cuentas configuradas para la nueva opción Diseño envolvente. En las cuentas configuradas con el diseño clásico, seguirá apareciendo la página de inicio clásica o existente. No se debería observar ningún cambio en la página de inicio.

Además, esta actualización también permite a los alumnos descargar su insignia como PDF y una imagen. La actualización también incorpora una ventana emergente de comentarios, que permite a los alumnos proporcionar comentarios sobre la aplicación de forma anónima.
...
Para todas las cuentas que tengan activada la opción Diseño envolvente, hay una nueva página de inicio que admite esta configuración.
...
* Un informe de puntuación de prueba L2 descargado para un módulo de contenido AICC mostraba una puntuación incorrecta en la columna Puntuación total del usuario / Puntuación de prueba. Este problema se ha solucionado.
...
* Las imágenes del banner no se eliminaban cuando el autor las suprimía si el curso se encontraba en el estado Borrador. Este problema se ha solucionado.
...
* Los cursos retirados no aparecen en los resultados de la búsqueda según lo previsto. Este problema se ha solucionado.
...
* No se completa la carga de CSV si los campos activos contienen caracteres especiales. Esto se ha solucionado.
...
* No se podía reanudar la reproducción para un tipo específico de contenido de SCORM-2004. Por lo tanto, los alumnos debían desplazarse al punto en que se quedaron. Esto ya se ha solucionado. El contenido ahora debe reanudarse desde el punto en el que lo dejó el usuario.
* Después de inscribirse en un curso, en algunos casos, el contenido no se reproduce como se esperaba. Este problema se ha solucionado.
...
* Se producía un problema al exportar la lista de alumnos dados de baja en el informe de inscripción en algunos casos. Esto ya se ha solucionado.
...
* Un instructor recibe invitaciones para todas sus sesiones, incluso aunque solo se haya añadido una nueva sesión. Este problema se ha solucionado.
...
* Diseño interactivo para una experiencia web móvil de la función de alumno
...
* Una insignia personalizada con una etiqueta de catálogo con un espacio no permite que el archivo PDF se descargue del modo esperado.
...
En esta actualización, también puede cambiar la imagen del titular de un objeto de aprendizaje.
...
* En el cuadro de diálogo **Añadir informe**, los selectores **Intervalo** y **Filtros** aparecen como secciones separadas. De forma predeterminada, ambas se muestran en estado contraído. Para obtener más información, consulte [***Crear informes***](../administrators/feature-summary/reports.md#report).
...
* Un calendario de aprendizaje mostraba el estado **Inscrito en la sesión** incluso cuando un responsable aún no había aprobado la inscripción. Ahora, hasta que el responsable aprueba la inscripción, el estado del alumno que se muestra es **Pendiente**.

* En un caso concreto, durante una sesión, el calendario de aprendizaje mostraba el estado **Inscrito** aunque el alumno había completado un curso.
...
Comparta imágenes, documentos o archivos de audio o vídeo en cualquier tablero, de modo que otros miembros puedan ver su publicación e iniciar una interacción.  Para obtener más información, consulte [***Compartir publicaciones***](../learners/feature-summary/ipad-android-tablet-users.md#socialmobile).
...
Asigne aptitudes en su cuenta con los dominios de aptitudes del sistema de gestión de aprendizaje Learning Manager. Esto ayuda a vincular las aptitudes de su cuenta con los dominios de aptitudes que Learning Manager admite para la revisión con asistencia automática. Para obtener más información, consulte [***Asignar aptitud con dominios***](../administrators/feature-summary/curation-skills.md).
...
* Cuando un responsable selecciona la opción **Este trimestre**, no se muestran los datos de inscripción, progreso y finalización de un objeto de aprendizaje. En esta versión, estos detalles ahora se muestran del modo previsto.
...
* Funciones completas de edición de objetos de aprendizaje adquiridos mediante catálogo compartido. Para obtener más información, consulte [***Control de catálogos compartidos***](../administrators/feature-summary/shared-catalog-full-control.md). Para habilitar la función, póngase en contacto con el departamento de asistencia de Learning Manager.
* Los instructores ya pueden identificar fácilmente las sesiones y los módulos con revisiones pendientes. Para obtener más información, consulte [***Revisiones pendientes***](../instructors/feature-summary/learners.md#pending).

* Las aptitudes ahora admiten la concesión de valores de crédito con decimales. De este modo, los autores pueden conceder valores de créditos con decimales a un determinado curso. Para obtener más información, consulte [***Uso de decimales***](../administrators/feature-summary/skills-levels.md#decimal).
...
* Los envíos requeridos para certificaciones externas y módulos de actividad ahora son opcionales. De este modo, los responsables y los instructores pueden evaluar sin necesidad de envíos. Para obtener más información, consulte [***Envío opcional***](../managers/feature-summary/learning-objects.md#optional).
...
* **Escanear código QR para inscribir:** Las funciones del código QR se han mejorado. Además de registrar la asistencia, el código QR ahora también permite inscribirse en un curso y completarlo.
  ...
  Para inscribirse en un curso y completarlo, puede escanear el código QR que le haya proporcionado el administrador. <!-- For more information on scanning QR codes in the web version of Learning Manager, see  [***Scan QR code***](https://helpx.adobe.com/captivate-Learning>Manager/whats-new.html#QRcodetoenrollcompleteenrollcompleteacourse) -->.

* **Varios intentos en el curso:** La aplicación de Learning Manager permite al alumno realizar cursos con varios intentos habilitados. <!-- For more information on setting up multiple attempts, see  [***Multiple attempts***](<https://helpx.adobe.com/captivate-Learning>Manager/authors/feature-summary/courses.html#Multiattempts). -->
...
* La inscripción de usuarios puede no realizarse correctamente cuando estos salen de un grupo de usuarios. Este problema se ha solucionado.
...
* Falta la certificación en el menú desplegable del informe del tablero, aunque está visible en la aplicación del administrador y en la lista de API de datos. Este problema se ha solucionado.
* El administrador no ha podido retirar algunos objetos de aprendizaje debido a la falta de permisos, aunque los catálogos compartidos son independientes de las cuentas de Learning Manager. Este problema se ha solucionado.
...
* Es posible que la información sobre actividades como la inscripción/finalización no esté presente en la transcripción del alumno descargada por un responsable. Esto se ha solucionado.
...
* Cuando buscaba y seleccionaba un alumno y marca su asistencia, Learning Manager podía marcar la asistencia de todos los alumnos. Esto se ha solucionado.
* Learning Manager mostraba la hora en los mensajes de correo electrónico con formato de 24 horas. Esto se ha solucionado. Ahora la hora se muestra con formato de 12 horas.
...
* Es posible que el instructor no pueda marcar la asistencia de todos los usuarios de una sola vez para las sesiones que formaran parte de un Programa de aprendizaje/Certificación. Este problema se ha solucionado.
...
**Problema:** Learning Manager puede llegar a bloquearse al acceder a determinados objetos de aprendizaje mediante Internet Explorer v11.1478.10586.0.

**Solución alternativa:** Actualice Internet Explorer 11 a la versión más actual. Si es preciso, consulte al personal de TI de su empresa.
...
* Si el catálogo predeterminado está desactivado, se crea un catálogo y el responsable tiene acceso a este nuevo catálogo, quizá no pueda encontrar ningún curso de ese catálogo. Este problema se ha solucionado.
* Los usuarios de la aplicación para dispositivos móviles podrían no recibir comentarios de L1 como notificaciones de inserción. Esto se ha solucionado.
...
* Los cambios en un curso compartido podían no propagarse a la cuenta del usuario si el autor de la cuenta de origen guardaba el curso automáticamente. Este problema se ha solucionado.
...
* Algunos mensajes de correo electrónico de Learning Manager, como los mensajes sin datos de notificación, no se activaban para los usuarios. Por ejemplo, un correo electrónico recibido al crear y activar un perfil externo o y un correo electrónico recibido al configurar la cuenta de Connect. Este problema se ha solucionado.
...
* En determinados casos, tras añadir un programa de aprendizaje a un catálogo, la opción de añadir podía seguir estando activada. Este problema se ha solucionado.
* Al abrir Learning Manager en el navegador de un dispositivo, se muestra una opción para utilizar Learning Manager en la aplicación del dispositivo. Al hacer clic en sí, se iniciará la Play Store (Android) si la aplicación no está instalada o se iniciará si está instalada (en Android e iOS). Este flujo de trabajo tenía problemas que se han solucionado.
...
Una línea de tiempo de la tabla de posiciones de interacción podría mostrar a un alumno como externo después de convertirlo de externo a interno. Este problema se ha solucionado.
...
El campo UUID se mostraba al alumno al completar su perfil aunque el administrador hubiera proporcionado el UUID para uno y varios usuarios de CSV. Este problema se ha solucionado.
...
* Cuando se escanea un código QR para módulos CR y VC mediante la aplicación para dispositivos Learning Manager.
...
* Al hacer clic en el índice, quizá no se contraiga automáticamente y se deba cerrar manualmente para ver el contenido. Este problema se ha solucionado.
...
* El índice no se cierra automáticamente si se cambia la orientación del dispositivo. Esto se ha solucionado.
...
* El botón de cerrar del reproductor no se muestra en determinados proyectos al cambiar la orientación del dispositivo. Esto se ha solucionado.
...
* Si un usuario no ha descargado ninguna ayuda de trabajo, al hacer clic en la ficha Mis ayudas de trabajo sin conexión, la aplicación se puede bloquear en iOS y mostrar un mensaje de error al cargar datos en Android. Se ha solucionado.
...
* Si se intenta eliminar una ayuda de trabajo que ya se ha añadido de la ficha Ayudas de trabajo, a veces puede aparecer un mensaje de error. Este problema se ha solucionado.
...
En esta versión se mejora el alcance de la interacción. Los usuarios externos ya pueden participar en la interacción. Como administrador, puede definir el ámbito de la interacción cambiando la configuración del ámbito. De forma selectiva, permita la interacción entre usuarios, grupos o ubicaciones de perfil similar.
...
Las ayudas de trabajo consisten en contenido de formación al que puede tener acceso un alumno sin inscribirse en ningún objeto de aprendizaje concreto como un curso o un programa de aprendizaje. Esta mejora permite que los administradores puedan extraer y descargar el informe de ayudas de trabajo. Como administrador, también puede generar un informe de todos los anuncios que ha enviado. Asimismo, los administradores y los responsables pueden extraer un informe de los alumnos que se han dado de baja.

**Conectores de Learning Manager**

Ya es posible exportar aptitudes de usuarios a una ubicación de FTP para su integración con cualquier otro sistema de terceros mediante la opción Exportación de datos. Puede especificar el nombre de conexión de la integración y elegir si va a importar usuarios internos o exportar aptitudes de usuarios mediante su configuración o la obtención a petición.

**Copiar instancias de curso**

Ya es posible copiar la URL de instancia haciendo clic en la flecha desplegable en la esquina superior derecha de una instancia.
...
Los recordatorios de plazo indicaban los días que faltaban incorrectamente en algunas zonas horarias. Este problema se ha solucionado.

**Problemas del programa de aprendizaje en el caso de instancia caducada de programa**
...
Utilice los widgets de la página de inicio para administrar sus cursos, aptitudes y logros. Utilice la barra de búsqueda para realizar una búsqueda en todo el sistema de gestión de aprendizaje, que abarca los objetos de aprendizaje, los catálogos, las aptitudes, las notas y los debates.
...
Cuando crea informes en Learning Manager, ahora puede generar informes y gráficos para catálogos.
...
Adobe Learning Manager ahora permite asignar tipos de entrega para sus cursos.
...
Con Learning Manager, ahora varios autores pueden editar el mismo grupo de contenidos de forma simultánea.

**Mejoras de Adobe Connect**

Ahora puede configurar una única dirección URL de Adobe Connect con varias cuentas de Learning Manager.
...
Al realizar un curso desarrollado en Captivate con la variable `code cpQuizInfoStudentName`, el nombre del alumno no aparecía correctamente. Se ha solucionado el problema.
...
* En la función de alumno, la eficacia de los cursos se mostraba como una de las opciones del filtro **Ordenar por**, aunque el administrador hubiera desactivado la eficacia de los cursos para los alumnos. Se ha solucionado el problema.
...
* Los borradores de cursos también se devolvían como respuesta cuando el administrador intentaba obtener todos los cursos.Se supone que estos borradores de cursos son privados del autor. Se ha solucionado el problema y ahora no se devuelven los borradores de cursos.
...
* Después de añadir un grupo de usuarios externos a Learning Manager, también puede pausar el proceso de registro de usuarios externos. En cualquier momento, puede revocar el bloqueo (pausa) seleccionando la opción Reanudar.
...
* Puede suscribirse a los informes de certificados, programas de aprendizaje o cursos. También puede suscribirse a informes de cursos individuales para los datos como el estado del alumno y la puntuación de prueba. Las suscripciones se le enviarán al ID de correo electrónico que registró en la cuenta de Learning Manager. También es posible cambiar este ID de correo electrónico.
* Al exportar el informe de inscripción de certificación, también se exporta una nueva columna denominada **Fecha de vencimiento**. Los datos de esta columna permiten a los administradores saber qué alumnos incumplieron los plazos de consumo de los objetos de aprendizaje.
...
* Cuando se publica y se ve un curso de Presenter con un título que contiene apóstrofo (&#39;) en el Administrador de aprendizaje, signos de interrogación (???) solía aparecer en el índice. Se ha solucionado el problema.
...
* Cuando un curso tenía dos instancias con el mismo nombre y dicho nombre era largo, no se creaban dos hojas de cálculo en el archivo Excel exportado. Este problema se ha solucionado.
...
Puede renovar las certificaciones en términos de meses mencionando el valor en el campo **Validez**. Anteriormente, la renovación de certificaciones solo se permitía en términos de años.
...
* La ficha **Retirado** aparecía dos veces en Programas de aprendizaje > instancias. Se ha solucionado el problema.
...
En el inicio de sesión de los alumnos, la información del nombre de la aptitud en **Mapa de aptitudes** no mostraba el nombre completo. Se ha solucionado el problema.

**Cómo añadir socios externos**

* En la página de registro de usuarios externos, se ha incluido el mensaje de texto **Los usuarios deben registrarse y crear primero una contraseña de nombre de usuario para los subsiguientes inicios de sesión**.
...
* Cuando un alumno externo intenta abrir los módulos previos al trabajo o de prueba utilizando el vínculo **Abrir notas** en la notificación de correo electrónico Regresar al curso, el contenido de las notas no se veía. Se ha solucionado el problema.

**Creación de cursos utilizando módulos**

Cuando un administrador intentaba inscribir alumnos a un curso mixto con un módulo de clase caducado, el cuadro de diálogo de inscripción no se abría. Este problema se ha solucionado.
...
Cuando un alumno externo hacía clic en el vínculo **Abrir notas** en la notificación de correo electrónico Regresar al curso, no funcionaba. Este problema ya se ha solucionado. Este vínculo abre el reproductor con notas, aunque el usuario no haya iniciado sesión en Learning Manager.
...
Los nombres de título de las plantillas de correo electrónico no eran adecuados. El contenido se actualiza en estos títulos de plantillas para que sea más legible.
...
Los administradores pueden definir el ámbito de la interacción cambiando la configuración del ámbito. De forma selectiva, permita la interacción entre usuarios, grupos o ubicaciones de perfil similar. Consulte [Interacción](../learners/feature-summary/gamification.md) para obtener más información.
...
Ahora puede eliminar cursos en las fases de borrador y retirado. Consulte [Cursos](../administrators/feature-summary/courses.md) para obtener más información. Si se elimina un objeto de aprendizaje, también se eliminan todos sus datos de informes. Si se elimina un curso que era parte de otro objeto de aprendizaje, el usuario recibe el mensaje correspondiente.

**Planes y programas de aprendizaje**

Puede aplicar el orden en que los alumnos pueden realizar los cursos dentro de los programas de aprendizaje. Puede eliminar programas de aprendizaje que estén en las fases de borrador y retirados. Si se elimina un objeto de aprendizaje, también se eliminan todos sus datos de informes.

**Certificaciones**

Puede eliminar certificaciones que estén en las fases de borrador y retiradas. Si se elimina un objeto de aprendizaje, también se eliminan todos sus datos de informes.
...
Cuando los usuarios hacen clic en **[!UICONTROL Cerrar sesión]** en Learning Manager, ahora cierran la sesión de la aplicación Learning Manager y también la de sus Adobe ID.
...
* Los autores pueden añadir o eliminar requisitos previos de cursos en los cursos publicados. Antes, esta función solo estaba disponible en los borradores de cursos.
...
* En la función de administrador, cuando se crean cursos con el cuadro de diálogo **Añadir objetos de aprendizaje**, los cursos retirados no aparecen en la lista de cursos.
...
* En la función de administrador, cuando un usuario introduce una serie de alumnos y hace clic en **Colocar orden**, aparece un cuadro de diálogo con detalles sobre los cargos de suscripción mensuales y anuales por usuario.
