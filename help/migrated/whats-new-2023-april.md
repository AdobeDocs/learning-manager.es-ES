...
## Mejoras en la experiencia de formación dirigida por instructor (ILT)

Se han realizado varias mejoras en la experiencia de Formación guiada por instructor (ILT). Entre las mejoras clave se incluyen: la capacidad de filtrar sesiones según la ubicación, la capacidad de cambiar instancias (VILT) sin perder el progreso, un nuevo &quot;Asistente de programación&quot; para gestionar los conflictos en las sesiones de reserva, la capacidad de adjuntar &quot;Aptitudes&quot; a los instructores y elegir instructores en función de las aptitudes.

### Qué ha cambiado

* La página Aptitudes de la aplicación de administrador tiene la opción de cargar la asignación de Aptitud e instructor.
...
Los autores, los administradores y los administradores/autores personalizados pueden utilizar el Asistente para programación.
...
## Nueva aplicación móvil de Adobe Learning Manager

Una nueva aplicación móvil de Adobe Learning Manager para Android y iOS que proporciona a los alumnos un acceso sencillo al aprendizaje sobre la marcha. La aplicación permite a los alumnos consumir formación en sus dispositivos móviles y reanudarla posteriormente en sus equipos de escritorio. Gracias a la compatibilidad con notificaciones, carga de archivos, facilidad para marcar y compartir contenido de aprendizaje, aprendizaje social y mucho más, la aplicación móvil proporciona una flexibilidad adicional a los alumnos y admite el aprendizaje Just-In-Time.
...
En esta versión, la aplicación admite estas funciones:

La nueva aplicación móvil admite las siguientes funciones clave en esta versión:
...
* Compatibilidad con LP mejorados
* Posibilidad de cambiar el idioma de la interfaz móvil a cualquier idioma compatible con Adobe Learning Manager.
* Compatibilidad con cargas de archivos en certificaciones externas, sesiones de clase real y virtual y módulos de actividad.
* Posibilidad de enviar comentarios del curso de L1 dentro de la aplicación.
* Compatibilidad con vínculos profundos.
* Asistencia para el aprendizaje social.
* Compatibilidad con insignias.
* Compatibilidad con el inicio de sesión de usuarios externos.
...
Para obtener más información, consulte [aplicación móvil de Adobe Learning Manager](/help/migrated/learners/feature-summary/ipad-android-tablet-users.md).

## Utilizar cualquier aplicación de escaneado de códigos QR para escanear códigos QR de Learning Manager
...
### Mejoras del anuncio de recomendación
...
En la página Anuncio hay una opción que muestra a un alumno por qué se le ha recomendado este curso o formación.
...
El administrador crea un anuncio añadiendo el curso para cualquier grupo de usuarios y lo publica.
...
A veces, desea que un alumno filtre una sesión en el calendario en función de la ubicación. Después de añadir una ubicación mediante el cuadro de diálogo Ubicaciones de clase o el archivo CSV, el alumno puede filtrar.
...
Como alumno, puede filtrar las sesiones que se le asignan por ubicación. Vaya al widget de calendario, seleccione Filtrar sesiones y seleccione la ubicación.
...
Después de crear la cuenta de prueba, los cursos en Mercado de contenido pasan a estar disponibles sin demora.

## Chatbot

Chatea con un agente o con varios agentes mediante un bot de chat. Solo los administradores personalizados de cuentas de prueba pueden utilizar esta función.

El bot de chat:

* Te damos la bienvenida con un mensaje.
* Proporcione una opción para obtener información sobre el producto o una demostración del producto.
* Transfiera el chat a un agente en vivo.
* Conserva tu historial de chat.
...
* Utilice el operador + para asegurarse de que sólo se muestran los resultados que contienen la frase o palabra específica. Por ejemplo, Programación informática +python mostrará solo los cursos de programación informática que contengan la palabra &quot;python&quot;.
...
Un alumno inscrito en una instancia concreta de un curso puede ver una lista de todas las instancias disponibles del curso y cambiar a otra instancia que funcione mejor para ellas. El motivo del cambio puede ser que el alumno no haya asistido a la instancia anterior o que el tiempo de sesión de la nueva instancia sea más adecuado o que pueda ser otra cosa.

Cualquier progreso realizado por el alumno como parte del curso, las puntuaciones de las pruebas de los alumnos, etc., se transfiere a la nueva instancia. Esta función está pensada principalmente para cursos en aula y mixtos, pero se admitirán todos los tipos de cursos, incluidos los de ritmo personalizado.
...
Cuando el alumno selecciona **Ver todas las instancias** Además, el alumno puede ver todas las instancias del curso.
...
Para obtener más información, consulte [Informe de seguimiento de auditoría de usuarios](/help/migrated/administrators/feature-summary/reports.md#useraudittrailreports).
...
Un nuevo informe para realizar un seguimiento de las ayudas de trabajo presentes en la cuenta y otra información sobre las ayudas de trabajo, como el idioma, el tipo, la duración, el autor, las etiquetas, etc.
...
Los administradores y los autores podrán enviar comunicaciones de correo electrónico específicas y ad hoc a los alumnos inscritos en una instancia específica de un curso. La opción para enviar correos electrónicos a nivel de instancia se ha añadido para Cursos y programas de aprendizaje.
...
Para obtener más información, consulte [Correos electrónicos de instancia](/help/migrated/administrators/feature-summary/courses.md#send-instance-level-emails).
...
En esta versión, hemos añadido plantillas de correo electrónico para gestores de nivel de salto. Estas plantillas están pensadas para cuando los responsables reciben correos electrónicos relativos a los informes de segundo nivel que carecen de cualquier curso, ruta de aprendizaje o plazos de certificación. Además, recibirán correos electrónicos cuando sus informes de segundo nivel se acerquen a los plazos de finalización de estos cursos, rutas de aprendizaje o certificaciones.
...
* Omitir escalación de nivel para completar la ruta de aprendizaje: antes de la fecha límite
* Omitir escalación de nivel para la fecha límite de ruta de aprendizaje perdida
* Omitir escalación de nivel para la finalización de la certificación: antes del plazo
...
Para obtener más información, consulte la [Documento de referencia de API](https://captivateprime.adobe.com/docs/primeapi/v2/).

### Conmutador de instancia de alumno
...
>1. Conmutador de instancia de curso
...
| Descripción | Nuevo parámetro/respuesta | Extremo |
|--- |--- |--- |
...
### Sesiones de alumno con conflictos
...
Un nuevo parámetro de consulta, filter.loFormat=Clase virtual para la API learningObjects.
...
### Historial de búsqueda del alumno
...
Un nuevo parámetro de consulta, sugerenciaType. Los valores aceptados son:
...
Puede ser una lista multivalor separada por comas para mayor flexibilidad y el procesamiento se basaría en la operación &quot;O&quot; entre los varios grupos. es decir, obtener todos los objetos de aprendizaje que se incluyen en los grupos de usuarios especificados.

### Grupo personalizado

Puede añadir y quitar usuarios externos a y desde grupos personalizados a través de la API.
...
* El GET /users/{userId}La API /userGroups tiene un nuevo parámetro, filter.annodGroupsOnly, que toma un valor booleano (true/false). De este modo, solo se filtran los grupos de usuarios que el administrador anuncia. El valor predeterminado de este parámetro es false.
