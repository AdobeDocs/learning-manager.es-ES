---
description: Creación de planes de aprendizaje para administradores en Learning Manager.
jcr-language: en_us
...
Creación de planes de aprendizaje para administradores en Learning Manager.

## Resumen {#overview}

Un plan de aprendizaje es un conjunto de reglas que inscriben a los alumnos en cursos de formación específicos en función de determinados criterios.

Un plan de aprendizaje permite a un administrador asignar automáticamente cursos, programas de aprendizaje o certificaciones en función de la ocurrencia de determinados eventos, como la incorporación de un nuevo empleado o el cambio de designación o ubicación de los empleados.

Por ejemplo, cuando un empleado se une a una organización, se le asigna automáticamente el Programa de orientación para nuevos empleados. Del mismo modo, si un empleado asciende a un puesto de responsable, se le asigna automáticamente un programa de orientación para nuevos responsables.

Puede inscribir alumnos en cualquier curso o programa de aprendizaje automáticamente en función de un conjunto predefinido de eventos. Puede crear rutas de aprendizaje para los alumnos asignando automáticamente una actividad de aprendizaje de seguimiento después de que un alumno complete una aptitud, un curso o un programa de aprendizaje.

## Crear planes de aprendizaje {#createlearningplans}

Para crear un plan de aprendizaje, debe iniciar sesión como administrador.

1. En el panel izquierdo, haga clic en **[!UICONTROL Planes de aprendizaje]**. Si existen eventos, se muestran en la página. Sin embargo, si está configurando la función de plan de aprendizaje por primera vez, continúe con el siguiente paso.
1. En la esquina superior derecha de la página, haga clic en **[!UICONTROL Añadir]**. En la **[!UICONTROL Añadir plan de aprendizaje]** , introduzca el nombre del plan de aprendizaje que debe realizar un empleado.

   ![](assets/add-learning-plandialog.png)

1. En la **[!UICONTROL Se produce cuando]** , elija el evento requerido. Las opciones determinan cuándo realiza el curso un alumno. Después de seleccionar el tipo de evento, seleccione la formación, los cursos, el programa de aprendizaje o la certificación correspondientes.
   ...
   **2 - Se añade el alumno a un grupo:** Cuando un nuevo usuario o empleado se une a un grupo.  Introduzca y seleccione el grupo de usuarios de la lista desplegable a la que se aplica este evento. Puede elegir varios grupos. Además, puede asignar este evento a todos los miembros existentes de estos grupos seleccionando la opción.

   ![](assets/learner-gets-addedtoagroup.png)

   Este plan de aprendizaje se ha diseñado específicamente para ***Personalizado - Grupo*** usuarios. Escriba el nombre del grupo en el campo y, mediante la búsqueda de escritura anticipada, elija el grupo o grupos.

   **3 - El alumno finaliza un objeto de aprendizaje:** El evento se activa cuando un alumno completa cualquier objeto de aprendizaje, como un curso, un programa de aprendizaje, etc. Seleccione el objeto de aprendizaje al que se aplica este evento. Seleccione el estado de finalización del evento. También puede elegir el grupo de usuarios al que pertenece este alumno. Indique el número de días, después de completar el objeto de aprendizaje, en el que este evento se activa. Seleccione la opción si desea asignar este evento a los usuarios existentes que ya hayan completado este objeto de aprendizaje.

   ![](assets/learner-completealearningobject.png)

   **4 - El alumno adquiere un nivel de aptitud:** Introduzca el nombre de la aptitud y seleccione el nivel. También puede elegir el grupo de usuarios al que pertenece este alumno. Es opcional. Indique el número de días, después de obtener la aptitud, en el que se activa este evento. Seleccione la opción si desea asignar este evento a alumnos existentes que ya han obtenido esta aptitud.

   ![](assets/learner-achievesaskilllevel.png)

   Además, defina el número de días tras los que se debe asignar el plan de aprendizaje a los alumnos.

   ![](assets/assign-learning.png)

   **5 - En una fecha específica:** Cuando los eventos deben ocurrir en una fecha específica. Seleccione la fecha en la que se debe asignar el evento. Seleccione los grupos de usuarios a los que se debe asignar automáticamente el evento. Seleccione las instancias que se deben asignar y, si lo desea, indique después de cuántos días debe activarse el evento.

   ![](assets/on-a-specific-date.png)

1. Para todos los eventos, puede seleccionar la instancia en el **[!UICONTROL Instancia]** lista desplegable. También puede seleccionar instancias del aprendizaje asignado para cualquier evento.

   ![](assets/choose-instance.png)

   En Learning Manager, un plan de aprendizaje crea su propia instancia, Automático. Al elegir un grupo, por ejemplo, Todos los alumnos, de forma predeterminada, todos los alumnos del plan de aprendizaje se inscriben en la instancia Automático.

   Al guardar el plan de aprendizaje, la instancia Automático aparece como una opción en el **[!UICONTROL Seleccionar instancia]** en la sección Alumnos de un curso.

1. Para guardar el plan de aprendizaje, haga clic en **[!UICONTROL Guardar]**.

## Dar de baja de formación {#unenroll-training}

Al añadir un plan de aprendizaje, un administrador puede dar de baja a usuarios de cursos de formación específicos en función de determinados activadores.
...
## El alumno finaliza un curso de formación {#learnercompletesatraining}
...
1. Elija la fecha en la que se debe dar de baja a los alumnos.
...
Después de crear un plan de aprendizaje, el administrador puede editar o actualizar el plan de aprendizaje en cualquier momento. Para editar, haga clic en el nombre del plan de aprendizaje y modifique los valores del **[!UICONTROL Editar plan de aprendizaje]** que aparece el cuadro de diálogo. Haga clic en **[!UICONTROL Guardar]**.

## Habilitar un plan de aprendizaje {#enablealearningplan}

De forma predeterminada, todos los nuevos planes de aprendizaje que ha creado están en estado desactivado. Debe habilitar un plan para que se asigne un alumno. Cuando se activa la casilla de verificación **[!UICONTROL Alumnos actuales]**, el evento se activa por sí mismo.
...
1. En la esquina superior derecha de la página, haga clic en **[!UICONTROL Acciones]** > **[!UICONTROL Habilitar]**. Esto activa el plan de aprendizaje.
...
1. En la esquina superior derecha de la página, haga clic en **[!UICONTROL Acciones]** > **[!UICONTROL Desactivar]**. Esto mueve el plan a la **[!UICONTROL Desactivado]** .

## Filtrar un plan de aprendizaje {#filteralearningplan}

Puede filtrar planes de aprendizaje según el tipo de evento utilizado al crear un plan de aprendizaje. Haga clic en **[!UICONTROL Tipo]** y elija cualquier opción para mostrar planes de aprendizaje que coincidan con la selección.
...
1. ¿Cómo configuro un plan de aprendizaje/inscripción automática para cursos de clase y clase virtual?
   ...
   Se recomienda configurar la instancia del curso con los detalles de sesión necesarios. A continuación, configure un plan de aprendizaje y asígnelo a la instancia del curso, que ya se ha creado.
