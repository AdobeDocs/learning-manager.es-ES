---
description: Defina y configure un sistema de identidad con el que se autenticarán los usuarios finales.
jcr-language: en_us
...
En la página principal del administrador de integración, haga clic en **[!UICONTROL ** Solicitar carpeta CSV FTP **.]** En el cuadro de diálogo emergente que aparece, introduzca su ID de correo electrónico. Vaya al asistente en línea para crear la cuenta de FTP de Exavault. Tan pronto como cree su cuenta, puede ver el proyecto de migración y las carpetas de proyectos de sprints en Exavault FTP.
...
***Si aún no ha creado una carpeta FTP, se le pedirá que cree una cuenta de Exavault para la carpeta FTP. Es un paso obligatorio para poder crear un proyecto de migración. ***
...
En la página Configuración de sprint, cree un sprint para su proyecto de migración. En el proceso de migración de Learning Manager, un sprint se define como un conjunto de elementos de migración que ha decidido migrar desde el LMS actual.
